...
func init() {
	proto.RegisterType((*BookParticipation)(nil), "furysports.xfury.orderbook.BookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "furysports.xfury.orderbook.ParticipationBetPair")
}

func init() {
	proto.RegisterFile("xfury/orderbook/participation.proto", fileDescriptor_48a996aa96d95967)
}
