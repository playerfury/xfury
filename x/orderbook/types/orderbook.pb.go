...
type OrderBook struct {
	...
	// order book status
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=playerfury.xfury.orderbook.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("playerfury.xfury.orderbook.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "playerfury.xfury.orderbook.OrderBook")
}

func init() { proto.RegisterFile("xfury/orderbook/orderbook.proto", fileDescriptor_7247ccc164993ca5) }
