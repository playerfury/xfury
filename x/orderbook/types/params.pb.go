...
func init() {
	proto.RegisterType((*Params)(nil), "playerfury.xfury.orderbook.Params")
}

func init() { proto.RegisterFile("xfury/orderbook/params.proto", fileDescriptor_3c3d2056747df0cc) }
