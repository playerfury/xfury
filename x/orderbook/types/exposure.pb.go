...
func init() {
	proto.RegisterType((*BookOddsExposure)(nil), "playerfury.xfury.orderbook.BookOddsExposure")
	proto.RegisterType((*ParticipationExposure)(nil), "playerfury.xfury.orderbook.ParticipationExposure")
}

func init() { proto.RegisterFile("xfury/orderbook/exposure.proto", fileDescriptor_3aa5f8fec7488c62) }
