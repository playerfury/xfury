...
func init() {
	proto.RegisterType((*GenesisState)(nil), "playerfury.xfury.orderbook.GenesisState")
}

func init() { proto.RegisterFile("xfury/orderbook/genesis.proto", fileDescriptor_b54e9379cfb7d94d) }
