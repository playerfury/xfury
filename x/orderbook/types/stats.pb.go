...
func init() {
	proto.RegisterType((*OrderBookStats)(nil), "playerfury.xfury.orderbook.OrderBookStats")
}

func init() { proto.RegisterFile("xfury/orderbook/stats.proto", fileDescriptor_bbf84578c9c8bd09) }
