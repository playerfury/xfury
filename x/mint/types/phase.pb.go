...
func init() {
	proto.RegisterType((*Phase)(nil), "furysports.xfury.mint.Phase")
}

func init() { proto.RegisterFile("xfury/mint/phase.proto", fileDescriptor_45212421f762a655) }
