...
// source: xfury/mint/minter.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "furysports.xfury.mint.Minter")
}

func init() { proto.RegisterFile("xfury/mint/minter.proto", fileDescriptor_953d7ad31a90642a) }
