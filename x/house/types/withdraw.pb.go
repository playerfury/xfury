...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=furysports.xfury.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("furysports.xfury.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "furysports.xfury.house.Withdrawal")
}

func init() { proto.RegisterFile("xfury/house/withdraw.proto", fileDescriptor_25d68f340acb0d1b) }
