...
// source: xfury/house/withdraw.proto
...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=playerfury.xfury.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("playerfury.xfury.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "playerfury.xfury.house.Withdrawal")
}

func init() { proto.RegisterFile("xfury/house/withdraw.proto", fileDescriptor_9ca852402ebf549d) }
