...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "playerfury.xfury.house.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "playerfury.xfury.house.QueryParamsResponse")
	proto.RegisterType((*QueryDepositsRequest)(nil), "playerfury.xfury.house.QueryDepositsRequest")
	proto.RegisterType((*QueryDepositsResponse)(nil), "playerfury.xfury.house.QueryDepositsResponse")
	proto.RegisterType((*QueryDepositorDepositsRequest)(nil), "playerfury.xfury.house.QueryDepositorDepositsRequest")
	proto.RegisterType((*QueryDepositorDepositsResponse)(nil), "playerfury.xfury.house.QueryDepositorDepositsResponse")
	proto.RegisterType((*QueryDepositorWithdrawalsRequest)(nil), "playerfury.xfury.house.QueryDepositorWithdrawalsRequest")
	proto.RegisterType((*QueryDepositorWithdrawalsResponse)(nil), "playerfury.xfury.house.QueryDepositorWithdrawalsResponse")
}

func init() { proto.RegisterFile("xfury/house/query.proto", fileDescriptor_436b89bf9285a4cb) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Deposits(ctx context.Context, in *QueryDepositsRequest, opts ...grpc.CallOption) (*QueryDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Query/Deposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DepositorDeposits(ctx context.Context, in *QueryDepositorDepositsRequest, opts ...grpc.CallOption) (*QueryDepositorDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Query/DepositorDeposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DepositorWithdrawals(ctx context.Context, in *QueryDepositorWithdrawalsRequest, opts ...grpc.CallOption) (*QueryDepositorWithdrawalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Query/DepositorWithdrawals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Query/Params",
	}
...
func _Query_Deposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Query/Deposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DepositorDeposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Query/DepositorDeposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DepositorWithdrawals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Query/DepositorWithdrawals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.xfury.house.Query",
