...
type MsgWithdraw struct {
	...
	Mode               WithdrawalMode                         `protobuf:"varint,4,opt,name=mode,proto3,enum=playerfury.xfury.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterType((*MsgDeposit)(nil), "playerfury.xfury.house.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "playerfury.xfury.house.MsgDepositResponse")
	proto.RegisterType((*MsgWithdraw)(nil), "playerfury.xfury.house.MsgWithdraw")
	proto.RegisterType((*MsgWithdrawResponse)(nil), "playerfury.xfury.house.MsgWithdrawResponse")
}

func init() { proto.RegisterFile("xfury/house/tx.proto", fileDescriptor_d3891d05e499977f) }
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Withdraw(ctx context.Context, in *MsgWithdraw, opts ...grpc.CallOption) (*MsgWithdrawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.house.Msg/Withdraw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Msg/Deposit",
	}
...
func _Msg_Withdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.house.Msg/Withdraw",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.xfury.house.Msg",
