...
// source: xfury/house/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "playerfury.xfury.house.GenesisState")
}

func init() { proto.RegisterFile("xfury/house/genesis.proto", fileDescriptor_aa4dcd3bb98435db) }
