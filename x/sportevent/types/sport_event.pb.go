...
func init() {
	proto.RegisterEnum("playerfury.xfury.sportevent.SportEventStatus", SportEventStatus_name, SportEventStatus_value)
	proto.RegisterType((*SportEvent)(nil), "playerfury.xfury.sportevent.SportEvent")
	proto.RegisterType((*EventBetConstraints)(nil), "playerfury.xfury.sportevent.EventBetConstraints")
}

func init() { proto.RegisterFile("xfury/sportevent/sport_event.proto", fileDescriptor_f4c38f73099259f8) }
