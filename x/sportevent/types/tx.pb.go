...
func init() {
	proto.RegisterType((*MsgAddSportEvent)(nil), "playerfury.xfury.sportevent.MsgAddSportEvent")
	proto.RegisterType((*MsgAddSportEventResponse)(nil), "playerfury.xfury.sportevent.MsgAddSportEventResponse")
	proto.RegisterType((*MsgResolveSportEvent)(nil), "playerfury.xfury.sportevent.MsgResolveSportEvent")
	proto.RegisterType((*MsgResolveSportEventResponse)(nil), "playerfury.xfury.sportevent.MsgResolveSportEventResponse")
	proto.RegisterType((*MsgUpdateSportEvent)(nil), "playerfury.xfury.sportevent.MsgUpdateSportEvent")
	proto.RegisterType((*MsgUpdateSportEventResponse)(nil), "playerfury.xfury.sportevent.MsgUpdateSportEventResponse")
}

func init() { proto.RegisterFile("xfury/sportevent/tx.proto", fileDescriptor_d0d8f6623c66e124) }
...
func (c *msgClient) AddSportEvent(ctx context.Context, in *MsgAddSportEvent, opts ...grpc.CallOption) (*MsgAddSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Msg/AddSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveSportEvent(ctx context.Context, in *MsgResolveSportEvent, opts ...grpc.CallOption) (*MsgResolveSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Msg/ResolveSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateSportEvent(ctx context.Context, in *MsgUpdateSportEvent, opts ...grpc.CallOption) (*MsgUpdateSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Msg/UpdateSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Msg/AddSportEvent",
	}
...
func _Msg_ResolveSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Msg/ResolveSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Msg/UpdateSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.xfury.sportevent.Msg",
