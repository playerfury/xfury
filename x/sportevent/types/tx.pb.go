...
// source: xfury/sportevent/tx.proto
...
func init() {
	proto.RegisterType((*MsgAddSportEvent)(nil), "furysports.xfury.sportevent.MsgAddSportEvent")
	proto.RegisterType((*MsgAddSportEventResponse)(nil), "furysports.xfury.sportevent.MsgAddSportEventResponse")
	proto.RegisterType((*MsgResolveSportEvent)(nil), "furysports.xfury.sportevent.MsgResolveSportEvent")
	proto.RegisterType((*MsgResolveSportEventResponse)(nil), "furysports.xfury.sportevent.MsgResolveSportEventResponse")
	proto.RegisterType((*MsgUpdateSportEvent)(nil), "furysports.xfury.sportevent.MsgUpdateSportEvent")
	proto.RegisterType((*MsgUpdateSportEventResponse)(nil), "furysports.xfury.sportevent.MsgUpdateSportEventResponse")
}

func init() { proto.RegisterFile("xfury/sportevent/tx.proto", fileDescriptor_0800a6bcea264c44) }
...
func (c *msgClient) AddSportEvent(ctx context.Context, in *MsgAddSportEvent, opts ...grpc.CallOption) (*MsgAddSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xfurysports.xfury.sportevent.Msg/AddSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveSportEvent(ctx context.Context, in *MsgResolveSportEvent, opts ...grpc.CallOption) (*MsgResolveSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xfurysports.xfury.sportevent.Msg/ResolveSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateSportEvent(ctx context.Context, in *MsgUpdateSportEvent, opts ...grpc.CallOption) (*MsgUpdateSportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xfurysports.xfury.sportevent.Msg/UpdateSportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xfurysports.xfury.sportevent.Msg/AddSportEvent",
	}
...
func _Msg_ResolveSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xfurysports.xfury.sportevent.Msg/ResolveSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateSportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xfurysports.xfury.sportevent.Msg/UpdateSportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furysports.xfury.sportevent.Msg",
	...
	Metadata: "xfury/sportevent/tx.proto",
}
