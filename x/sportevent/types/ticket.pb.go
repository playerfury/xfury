...
type SportEventAddTicketPayload struct {
	...
	Status SportEventStatus `protobuf:"varint,5,opt,name=status,proto3,enum=playerfury.xfury.sportevent.SportEventStatus" json:"status,omitempty"`
...
type SportEventUpdateTicketPayload struct {
	...
	Status SportEventStatus `protobuf:"varint,6,opt,name=status,proto3,enum=playerfury.xfury.sportevent.SportEventStatus" json:"status,omitempty"`
}
...
type SportEventResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status SportEventStatus `protobuf:"varint,4,opt,name=status,proto3,enum=playerfury.xfury.sportevent.SportEventStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*SportEventAddTicketPayload)(nil), "playerfury.xfury.sportevent.SportEventAddTicketPayload")
	proto.RegisterType((*SportEventUpdateTicketPayload)(nil), "playerfury.xfury.sportevent.SportEventUpdateTicketPayload")
	proto.RegisterType((*SportEventResolutionTicketPayload)(nil), "playerfury.xfury.sportevent.SportEventResolutionTicketPayload")
}

func init() { proto.RegisterFile("xfury/sportevent/ticket.proto", fileDescriptor_b7e970e0fce71fcc) }
