...
func init() {
	proto.RegisterType((*SportEventStats)(nil), "playerfury.xfury.sportevent.SportEventStats")
}

func init() { proto.RegisterFile("xfury/sportevent/stats.proto", fileDescriptor_bc09ed4418b895cc) }
