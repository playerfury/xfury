...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "playerfury.xfury.sportevent.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "playerfury.xfury.sportevent.QueryParamsResponse")
	proto.RegisterType((*QuerySportEventRequest)(nil), "playerfury.xfury.sportevent.QuerySportEventRequest")
	proto.RegisterType((*QuerySportEventResponse)(nil), "playerfury.xfury.sportevent.QuerySportEventResponse")
	proto.RegisterType((*QuerySportEventsRequest)(nil), "playerfury.xfury.sportevent.QuerySportEventsRequest")
	proto.RegisterType((*QuerySportEventsResponse)(nil), "playerfury.xfury.sportevent.QuerySportEventsResponse")
	proto.RegisterType((*QuerySportEventsByUIDsRequest)(nil), "playerfury.xfury.sportevent.QuerySportEventsByUIDsRequest")
	proto.RegisterType((*QuerySportEventsByUIDsResponse)(nil), "playerfury.xfury.sportevent.QuerySportEventsByUIDsResponse")
}

func init() { proto.RegisterFile("xfury/sportevent/query.proto", fileDescriptor_45776640ee419e76) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEvent(ctx context.Context, in *QuerySportEventRequest, opts ...grpc.CallOption) (*QuerySportEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Query/SportEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEvents(ctx context.Context, in *QuerySportEventsRequest, opts ...grpc.CallOption) (*QuerySportEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Query/SportEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SportEventsByUIDs(ctx context.Context, in *QuerySportEventsByUIDsRequest, opts ...grpc.CallOption) (*QuerySportEventsByUIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.sportevent.Query/SportEventsByUIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Query/Params",
	}
...
func _Query_SportEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Query/SportEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SportEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Query/SportEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SportEventsByUIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.sportevent.Query/SportEventsByUIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.xfury.sportevent.Query",
