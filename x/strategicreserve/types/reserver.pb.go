...
func init() {
	proto.RegisterType((*Reserver)(nil), "playerfury.xfury.strategicreserve.Reserver")
}

func init() {
	proto.RegisterFile("xfury/strategicreserve/reserver.proto", fileDescriptor_a346a0fea33afb26)
}
