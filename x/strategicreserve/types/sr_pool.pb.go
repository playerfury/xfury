...
func init() {
	proto.RegisterType((*SRPool)(nil), "furysports.xfury.strategicreserve.SRPool")
}

func init() {
	proto.RegisterFile("xfury/strategicreserve/sr_pool.proto", fileDescriptor_4d28a376abe36b4a)
}
