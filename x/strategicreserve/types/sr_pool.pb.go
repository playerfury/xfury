...
// source: xfury/strategicreserve/sr_pool.proto
...
func init() {
	proto.RegisterType((*SRPool)(nil), "playerfury.xfury.strategicreserve.SRPool")
}

func init() {
	proto.RegisterFile("xfury/strategicreserve/sr_pool.proto", fileDescriptor_c939b57bb279fe3c)
}
