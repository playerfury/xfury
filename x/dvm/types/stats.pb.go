...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "furysports.xfury.dvm.ProposalStats")
}

func init() { proto.RegisterFile("xfury/dvm/stats.proto", fileDescriptor_54deed90ede215b3) }
