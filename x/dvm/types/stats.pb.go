...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "playerfury.xfury.dvm.ProposalStats")
}

func init() { proto.RegisterFile("xfury/dvm/stats.proto", fileDescriptor_18b1583139df99d6) }
