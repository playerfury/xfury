...
type ProposalVotePayload struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=playerfury.xfury.dvm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "playerfury.xfury.dvm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "playerfury.xfury.dvm.ProposalVotePayload")
}

func init() { proto.RegisterFile("xfury/dvm/ticket.proto", fileDescriptor_7121f0f264448d06) }
