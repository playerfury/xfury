...
type PublicKeysChangeFinishedProposal struct {
	...
	Result ProposalResult `protobuf:"varint,2,opt,name=result,proto3,enum=playerfury.xfury.dvm.ProposalResult" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("playerfury.xfury.dvm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "playerfury.xfury.dvm.PublicKeysChangeProposal")
	proto.RegisterType((*PublicKeysChangeFinishedProposal)(nil), "playerfury.xfury.dvm.PublicKeysChangeFinishedProposal")
}

func init() { proto.RegisterFile("xfury/dvm/proposal.proto", fileDescriptor_29058a11b4a243d6) }
