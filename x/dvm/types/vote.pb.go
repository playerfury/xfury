...
func init() {
	proto.RegisterEnum("playerfury.xfury.dvm.ProposalVote", ProposalVote_name, ProposalVote_value)
	proto.RegisterType((*Vote)(nil), "playerfury.xfury.dvm.Vote")
}

func init() { proto.RegisterFile("xfury/dvm/vote.proto", fileDescriptor_c881d83c5c5286a5) }
