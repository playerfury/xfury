...
// source: xfury/dvm/key_vault.proto
...
func init() {
	proto.RegisterType((*KeyVault)(nil), "furysports.xfury.dvm.KeyVault")
}

func init() { proto.RegisterFile("xfury/dvm/key_vault.proto", fileDescriptor_99efbc024ef3b828) }
