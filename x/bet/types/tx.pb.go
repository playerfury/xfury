...
func init() {
	proto.RegisterType((*MsgPlaceBet)(nil), "playerfury.xfury.bet.MsgPlaceBet")
	proto.RegisterType((*MsgPlaceBetResponse)(nil), "playerfury.xfury.bet.MsgPlaceBetResponse")
}

func init() { proto.RegisterFile("xfury/bet/tx.proto", fileDescriptor_38b4167f68c2a7f8) }
...
func (c *msgClient) PlaceBet(ctx context.Context, in *MsgPlaceBet, opts ...grpc.CallOption) (*MsgPlaceBetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.xfury.bet.Msg/PlaceBet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.xfury.bet.Msg/PlaceBet",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.xfury.bet.Msg",
