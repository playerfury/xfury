...
func init() {
	proto.RegisterType((*MsgPlaceBet)(nil), "furysports.xfury.bet.MsgPlaceBet")
	proto.RegisterType((*MsgPlaceBetResponse)(nil), "furysports.xfury.bet.MsgPlaceBetResponse")
}

func init() { proto.RegisterFile("xfury/bet/tx.proto", fileDescriptor_6c203a4d84c3ec3b) }
...
func (c *msgClient) PlaceBet(ctx context.Context, in *MsgPlaceBet, opts ...grpc.CallOption) (*MsgPlaceBetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xfurysports.xfury.bet.Msg/PlaceBet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlaceBet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xfurysports.xfury.bet.Msg/PlaceBet",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furysports.xfury.bet.Msg",
