...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "playerfury.xfury.bet.KycDataPayload")
}

func init() { proto.RegisterFile("xfury/bet/kyc.proto", fileDescriptor_13abc80c3002dbc4) }
