...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "furysports.xfury.bet.KycDataPayload")
}

func init() { proto.RegisterFile("xfury/bet/kyc.proto", fileDescriptor_86c57b300b6a4011) }
