...
func init() {
	proto.RegisterEnum("playerfury.xfury.bet.OddsType", OddsType_name, OddsType_value)
}

func init() { proto.RegisterFile("xfury/bet/odds_type.proto", fileDescriptor_9054da535c81741c) }
