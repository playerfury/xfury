...
func init() {
	proto.RegisterType((*PlaceBetFields)(nil), "furysports.xfury.bet.PlaceBetFields")
}

func init() { proto.RegisterFile("xfury/bet/place_bet_fields.proto", fileDescriptor_cd76c6e1ec0be0ef) }
