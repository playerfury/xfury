...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=playerfury.xfury.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "playerfury.xfury.bet.BetPlacementTicketPayload")
}

func init() { proto.RegisterFile("xfury/bet/ticket.proto", fileDescriptor_cf6959e7db451613) }
