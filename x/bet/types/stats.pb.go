...
func init() {
	proto.RegisterType((*BetStats)(nil), "playerfury.xfury.bet.BetStats")
}

func init() { proto.RegisterFile("xfury/bet/stats.proto", fileDescriptor_e7bd589ff6fa2d86) }
