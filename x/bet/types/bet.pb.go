...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=playerfury.xfury.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=playerfury.xfury.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=playerfury.xfury.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("playerfury.xfury.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("playerfury.xfury.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "playerfury.xfury.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "playerfury.xfury.bet.UID2ID")
	proto.RegisterType((*ActiveBet)(nil), "playerfury.xfury.bet.ActiveBet")
	proto.RegisterType((*SettledBet)(nil), "playerfury.xfury.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "playerfury.xfury.bet.BetFulfillment")
}

func init() { proto.RegisterFile("xfury/bet/bet.proto", fileDescriptor_9bc076bb1a4d9f6e) }
