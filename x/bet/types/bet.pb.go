...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=furysports.xfury.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=furysports.xfury.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=furysports.xfury.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("furysports.xfury.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("furysports.xfury.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "furysports.xfury.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "furysports.xfury.bet.UID2ID")
	proto.RegisterType((*ActiveBet)(nil), "furysports.xfury.bet.ActiveBet")
	proto.RegisterType((*SettledBet)(nil), "furysports.xfury.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "furysports.xfury.bet.BetFulfillment")
}

func init() { proto.RegisterFile("xfury/bet/bet.proto", fileDescriptor_5babc7dd42d65118) }
